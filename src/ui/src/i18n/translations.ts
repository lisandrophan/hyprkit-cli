...
export const translations = {
	en: {
		...
		fieldHookSessionState: "Session State",
		fieldHookSessionStateDesc: "Persist session state for handoff and statusline context",
		fieldHookCookAfterPlanReminder: "Cook After Plan Reminder",
		fieldHookCookAfterPlanReminderDesc: "Remind agents to continue implementation after planning",
		...
		fieldHookPlanFormatKanban: "Plan Format Kanban",
		fieldHookPlanFormatKanbanDesc: "Keep plan kanban metadata synchronized after edits",
		fieldHookUsageQuotaCacheRefresh: "Usage Quota Cache",
		fieldHookUsageQuotaCacheRefreshDesc: "Refresh cached usage quota information",
		...
		migrateGlobalForced:
			"Selected provider commands only support global scope. Use Global to install them.",
	...
	vi: {
		...
		fieldHookSessionState: "Trạng thái phiên",
		fieldHookSessionStateDesc: "Lưu trạng thái phiên cho bàn giao và statusline",
		fieldHookCookAfterPlanReminder: "Nhắc cook sau plan",
		fieldHookCookAfterPlanReminderDesc: "Nhắc agent tiếp tục triển khai sau khi lập kế hoạch",
		...
		fieldHookPlanFormatKanban: "Định dạng kanban plan",
		fieldHookPlanFormatKanbanDesc: "Đồng bộ metadata kanban của plan sau khi chỉnh sửa",
		fieldHookUsageQuotaCacheRefresh: "Cache hạn mức sử dụng",
		fieldHookUsageQuotaCacheRefreshDesc: "Làm mới cache thông tin hạn mức sử dụng",
		...
		migrateGlobalOnlyCommandsShort: "Commands chỉ hỗ trợ global",
		migrateNoProviders: "Không có provider khả dụng.",
		migrateUnsupported: "Sẽ bỏ qua (không hỗ trợ)",
		migrateGlobalForced: "Provider đã chọn chỉ hỗ trợ command ở global scope. Chọn Global để cài.",
